...
public class BouncerAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //this is where the agent receives the target's position. We don't like this. How do you define sensors for the agent?
    ...
    private void Update()
    {
        ...
        if (orientation.magnitude > float.Epsilon)
        {
            ...
            agentObject.transform.rotation 
            = Quaternion.Lerp(agentObject.transform.rotation, Quaternion.LookRotation(orientation), Time.deltaTime * 10f);
        }
    }
    ...
    public override void OnEpisodeBegin()
    {
        ...
        //this is a reference to the environment which is also problematic
        var environment = gameObject.transform.parent.gameObject;
        var targets = environment.GetComponentsInChildren<BouncerTarget>();
